...
func TestBuildDetailedReportCreatesSummaryAndDetailSheets(t *testing.T) {
	...
	report := &domain.DetailedReport{
		...
		Data:    []domain.DetailedReportRow{{ID: "claim", ServiceDate: date, MealType: domain.Afternoon, ShiftType: "DIA", Status: domain.ClaimNotClaimed, WorkerID: "worker", FullName: "María Pérez", DocumentNumber: "****5678", EmployeeCode: "EMP-001"}},
	}
